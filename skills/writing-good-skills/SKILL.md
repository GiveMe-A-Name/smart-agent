...
- description format — use the recommended template: "Invoke [when/unless] [observable condition]. Cost of unnecessary invocation: [specific minor cost]. Cost of missing: [specific major harm]." This makes cost asymmetry explicit and forces reasoning about observable conditions vs impressions. See `references/description-patterns.md`
